<%-- 
    Document   : index
    Created on : Jun 1, 2013, 2:52:59 PM
    Author     : kruno
--%>
                        ...
                        <center>
                            ...
                            <form id="login" method="POST" action="${pageContext.servletContext.contextPath}/ProvjeraKorisnika">
                                ...
                                &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
                                 Lozinka: <input type="password" name="j_password"/>  <br/><br/>
                                <input type="submit" value="Prijavi se" style="opacity:0.5" class="btn btn-large btn-block"/>
                            </form>
                        </center>
                    </div>
                </body>
