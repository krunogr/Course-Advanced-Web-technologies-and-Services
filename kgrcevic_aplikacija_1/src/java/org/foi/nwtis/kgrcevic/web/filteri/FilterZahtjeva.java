 ...
 */
package org.foi.nwtis.kgrcevic.web.filteri;
...
import static org.foi.nwtis.kgrcevic.web.slusaci.SlusacAplikacije.bp;

/**

 * Filter koji mjeri vrijeme trajanja zahtjeva korisnika kroz aplikaciju te je
 * upisuje u bazu.
 *  
 * @author Kruno
 *
...
public class FilterZahtjeva implements Filter {
     ...
     *
     * glavna metoda koja dohvaća podatke za spajanje iz konfiguracijske
     * datoteke te upisuje zahtjev korisnika i njegovo trajanje u bazu
     */
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        try {
            ...
            System.out.println(requestURI + " Vrijeme trajanja:  " + (end - start) + " ms ");
            ...
            try {
                try {
                    ...
                    Logger.getLogger(FilterZahtjeva.class.getName()).log(Level.SEVERE, null, ex);
                }
                Connection con = DriverManager.getConnection(bp.getServer_database() + bp.getUserDatabase(), bp.getUserUsername(), bp.getUserPassword());
                Statement stmt = con.createStatement();
                stmt.execute("INSERT INTO kgrcevic_dnevnik (zahtjev,vrijemepocetka,vrijemezavrsetka,trajanje) VALUES ('" + requestURI + "','" + sdf.format(start) + "','" + sdf.format(end) + "','" + razlika + "')");
                stmt.close();
                con.close();
                //
    ...
    class RequestWrapper extends HttpServletRequestWrapper {
        ...
        public void setParameter(String name, String[] values) {
            if (debug) {
                System.out.println("FilterZahtjeva::setParameter(" + name + "=" + values + ")" + " localParams = " + localParams);
            }
        ...
        public String getParameter(String name) {
            if (debug) {
                System.out.println("FilterZahtjeva::getParameter(" + name + ") localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public String[] getParameterValues(String name) {
            if (debug) {
                System.out.println("FilterZahtjeva::getParameterValues(" + name + ") localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public Enumeration getParameterNames() {
            if (debug) {
                System.out.println("FilterZahtjeva::getParameterNames() localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public Map getParameterMap() {
            if (debug) {
                System.out.println("FilterZahtjeva::getParameterMap() localParams = " + localParams);
            }
            if (localParams == null) {
